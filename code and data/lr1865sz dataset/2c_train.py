...
Data from the LR1865SZ batteries at a 2C charging rate are adopted.
"""
...
# training dataset
location = 'data/'
curve_cell_1 = np.genfromtxt(location+'lr1865sz_2c_1_350_419.txt',delimiter = ',')
curve_cell_2 = np.genfromtxt(location+'lr1865sz_2c_2_350_419.txt',delimiter = ',')
curve_cell_3 = np.genfromtxt(location+'lr1865sz_2c_3_350_419.txt',delimiter = ',')
curve_cell_4 = np.genfromtxt(location+'lr1865sz_2c_4_350_419.txt',delimiter = ',')

curve_cell_1 = curve_cell_1*3600 # Ah to As
...
curve_test = [curve_cell_2,curve_cell_4]
...
# checkpoint
filepath="models/2c-{epoch:02d}-{val_loss:.2f}.hdf5"
