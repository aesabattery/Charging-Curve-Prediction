...
# training dataset
curve_cell_1 = np.genfromtxt('q_curve_28_419_cell_1.txt',delimiter = ',')
curve_cell_2 = np.genfromtxt('q_curve_28_419_cell_2.txt',delimiter = ',')
curve_cell_3 = np.genfromtxt('q_curve_28_419_cell_3.txt',delimiter = ',')
curve_cell_4 = np.genfromtxt('q_curve_28_419_cell_4.txt',delimiter = ',')
curve_cell_5 = np.genfromtxt('q_curve_28_419_cell_5.txt',delimiter = ',')
curve_cell_6 = np.genfromtxt('q_curve_28_419_cell_6.txt',delimiter = ',')
curve_train = [curve_cell_1,curve_cell_2,curve_cell_3,curve_cell_4,
               curve_cell_5,curve_cell_6]
# test dataset
curve_cell_7 = np.genfromtxt('q_curve_28_419_cell_7.txt',delimiter = ',')
curve_cell_8 = np.genfromtxt('q_curve_28_419_cell_8.txt',delimiter = ',')
...
filepath="300mV-{epoch:02d}-{val_loss:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True,
mode='auto',period=2)
callbacks_list = [checkpoint]
# the epochs is set to 50 as a fast example
